...
class SchemaRegistryTests extends IndexScannerTestBase {
    ...
    void testParameterizedNameCollisionsUseSequence() throws IOException, JSONException {
        ...
        Schema s1 = registry.register(n1.type(), Collections.emptySet(), SmallRyeSchema.newInstance());
        Schema s2 = registry.register(n2.type(), Collections.emptySet(), SmallRyeSchema.newInstance());
        Schema s3 = registry.register(n3.type(), Collections.emptySet(), SmallRyeSchema.newInstance());
    ...
    void testWildcardLowerBoundName() throws IOException, JSONException {
        ...
        Schema s4 = registry.register(n4.type(), Collections.emptySet(), SmallRyeSchema.newInstance());
    ...
    void testWildcardUpperBoundName() throws IOException, JSONException {
        ...
        Schema s5 = registry.register(n5.type(), Collections.emptySet(), SmallRyeSchema.newInstance());
    ...
    void testWildcardWithGivenName() throws IOException, JSONException {
        ...
        Schema s6 = registry.register(n6.type(), Collections.emptySet(), SmallRyeSchema.newInstance());

@OASModelType(name = "OAuthFlow", parent = io.smallrye.openapi.internal.models.BaseExtensibleModel.class, constructible = org.eclipse.microprofile.openapi.models.security.OAuthFlow.class, properties = {
...
@OASModelType(name = "OAuthFlows", parent = io.smallrye.openapi.internal.models.BaseExtensibleModel.class, constructible = org.eclipse.microprofile.openapi.models.security.OAuthFlows.class, properties = {
...
@OASModelType(name = "AbstractSecurityRequirement", incomplete = true, parent = io.smallrye.openapi.internal.models.BaseModel.class, constructible = org.eclipse.microprofile.openapi.models.security.SecurityRequirement.class, properties = {
        @OASModelProperty(name = "schemes", unwrapped = true, type = Map.class, valueTypeLiteral = "java.util.List<String>"),
})
@OASModelType(name = "SecurityScheme", parent = io.smallrye.openapi.internal.models.BaseExtensibleModel.class, constructible = org.eclipse.microprofile.openapi.models.security.SecurityScheme.class, properties = {

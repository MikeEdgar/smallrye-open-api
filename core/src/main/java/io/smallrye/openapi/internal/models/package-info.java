@OASModelType(name = "Components", parent = io.smallrye.openapi.internal.models.BaseExtensibleModel.class, constructible = org.eclipse.microprofile.openapi.models.Components.class, properties = {
...
@OASModelType(name = "ExternalDocumentation", parent = io.smallrye.openapi.internal.models.BaseExtensibleModel.class, constructible = org.eclipse.microprofile.openapi.models.ExternalDocumentation.class, properties = {
        @OASModelProperty(name = "description", type = String.class),
        @OASModelProperty(name = "url", type = String.class),
})
@OASModelType(name = "AbstractOpenAPI", incomplete = true, parent = io.smallrye.openapi.internal.models.BaseExtensibleModel.class, constructible = org.eclipse.microprofile.openapi.models.OpenAPI.class, properties = {
...
@OASModelType(name = "Operation", parent = io.smallrye.openapi.internal.models.BaseExtensibleModel.class, constructible = org.eclipse.microprofile.openapi.models.Operation.class, properties = {
...
@OASModelType(name = "AbstractPathItem", incomplete = true, parent = io.smallrye.openapi.internal.models.BaseExtensibleModel.class, constructible = org.eclipse.microprofile.openapi.models.PathItem.class, properties = {
...
@OASModelType(name = "Paths", parent = io.smallrye.openapi.internal.models.BaseExtensibleModel.class, constructible = org.eclipse.microprofile.openapi.models.Paths.class, properties = {

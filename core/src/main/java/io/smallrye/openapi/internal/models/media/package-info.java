@OASModelType(name = "Content", parent = io.smallrye.openapi.internal.models.BaseModel.class, constructible = org.eclipse.microprofile.openapi.models.media.Content.class, properties = {
...
@OASModelType(name = "Discriminator", parent = io.smallrye.openapi.internal.models.BaseModel.class, constructible = org.eclipse.microprofile.openapi.models.media.Discriminator.class, properties = {
...
@OASModelType(name = "Encoding", parent = io.smallrye.openapi.internal.models.BaseExtensibleModel.class, constructible = org.eclipse.microprofile.openapi.models.media.Encoding.class, properties = {
...
@OASModelType(name = "MediaType", parent = io.smallrye.openapi.internal.models.BaseExtensibleModel.class, constructible = org.eclipse.microprofile.openapi.models.media.MediaType.class, properties = {
...
@OASModelType(name = "AbstractSchema", incomplete = true, parent = io.smallrye.openapi.internal.models.BaseExtensibleModel.class, constructible = org.eclipse.microprofile.openapi.models.media.Schema.class, properties = {
...
@OASModelType(name = "XML", parent = io.smallrye.openapi.internal.models.BaseExtensibleModel.class, constructible = org.eclipse.microprofile.openapi.models.media.XML.class, properties = {

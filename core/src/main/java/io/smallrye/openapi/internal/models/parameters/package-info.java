@OASModelType(name = "Parameter", parent = io.smallrye.openapi.internal.models.BaseExtensibleModel.class, constructible = org.eclipse.microprofile.openapi.models.parameters.Parameter.class, properties = {
...
@OASModelType(name = "AbstractRequestBody", incomplete = true, parent = io.smallrye.openapi.internal.models.BaseExtensibleModel.class, constructible = org.eclipse.microprofile.openapi.models.parameters.RequestBody.class, properties = {
        @OASModelProperty(name = "ref", type = String.class),
        @OASModelProperty(name = "description", type = String.class),
        @OASModelProperty(name = "content", type = org.eclipse.microprofile.openapi.models.media.Content.class),
        @OASModelProperty(name = "required", type = Boolean.class),
